...
public class RoboWorld extends World {
  ...
  public RoboWorld(Set<Item> blockset) {
    super();
  ...
  public String toJSON() {
    ...
    return "[[-3,-2,\"path\", null],[1,1,\"path\", null]]";
    /*
    LogInfo.logs(
      Json.writeValueAsStringHard(allItems.stream().map(c -> {
  ...
  private static RoboWorld fromJSON(String wallString) {
    ...
    RoboWorld world = new RoboWorld(cubes);
